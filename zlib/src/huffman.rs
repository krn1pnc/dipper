...
fn get_huffman_codes(
    ...
    if is_distance {
        if max_length == 0 {
            return Ok(());
        } else if max_length == 1 && length_count[1] == 1 {
            let symbol = lengths.iter().position(|&x| x != 0).unwrap();
            codes[symbol] = 0;
            return Ok(());
        }
    }
...
impl HuffmanTable {
    ...
    pub fn try_from(lengths: &[u8], is_distance: bool) -> Result<Self, DecompressError> {
        ...
        for i in 0..code_count {
            ...
            let variable_bit_count = 16 - lengths[i];
    ...
    pub fn decode(&self, state: u16) -> DecodeResult {
        return self.table[state as usize];
    }
}
...
mod test {
    ...
    fn test_rfc1951_example1() {
        ...
        assert_eq!(
            t.decode(0b_10_000000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 0,
                bits_used: 2
            },
        ...
        assert_eq!(
            t.decode(0b_0_0000000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 1,
                bits_used: 1
            }
        ...
        assert_eq!(
            t.decode(0b_110_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 2,
                bits_used: 3
            },
        ...
        assert_eq!(
            t.decode(0b_111_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 3,
                bits_used: 3
            },
    ...
    fn test_rfc1951_example2() {
        ...
        assert_eq!(
            t.decode(0b_010_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 0,
                bits_used: 3
            },
        ...
        assert_eq!(
            t.decode(0b_011_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 1,
                bits_used: 3
            }
        ...
        assert_eq!(
            t.decode(0b_100_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 2,
                bits_used: 3
            },
        ...
        assert_eq!(
            t.decode(0b_101_00000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 3,
                bits_used: 3
            },
        ...
        assert_eq!(
            t.decode(0b_00_000000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 5,
                bits_used: 2
            }
        ...
        assert_eq!(
            t.decode(0b_1110_0000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 6,
                bits_used: 4
            },
        ...
        assert_eq!(
            t.decode(0b_1111_0000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 7,
                bits_used: 4
            },
    ...
    fn test_full_length() {
        ...
        assert_eq!(
            t.decode(0b_11110_000_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 4,
                bits_used: 5
            },
        ...
        assert_eq!(
            t.decode(0b_111110_00_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 5,
                bits_used: 6
            },
        ...
        assert_eq!(
            t.decode(0b_1111110_0_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 6,
                bits_used: 7
            },
        ...
        assert_eq!(
            t.decode(0b_11111110_u8.reverse_bits() as u16),
            DecodeResult {
                symbol: 7,
                bits_used: 8
            },
        ...
        assert_eq!(
            t.decode(0b_1_1111_1110_0000000_u16.reverse_bits()),
            DecodeResult {
                symbol: 8,
                bits_used: 9
            },
        ...
        assert_eq!(
            t.decode(0b_11_1111_1110_000000_u16.reverse_bits()),
            DecodeResult {
                symbol: 9,
                bits_used: 10
            },
        ...
        assert_eq!(
            t.decode(0b_111_1111_1110_00000_u16.reverse_bits()),
            DecodeResult {
                symbol: 10,
                bits_used: 11
            },
        ...
        assert_eq!(
            t.decode(0b_1111_1111_1110_0000_u16.reverse_bits()),
            DecodeResult {
                symbol: 11,
                bits_used: 12
            },
        ...
        assert_eq!(
            t.decode(0b_1_1111_1111_1110_000_u16.reverse_bits()),
            DecodeResult {
                symbol: 12,
                bits_used: 13
            },
        ...
        assert_eq!(
            t.decode(0b_11_1111_1111_1110_00_u16.reverse_bits()),
            DecodeResult {
                symbol: 13,
                bits_used: 14
            },
        ...
        assert_eq!(
            t.decode(0b_111_1111_1111_1110_0_u16.reverse_bits()),
            DecodeResult {
                symbol: 14,
                bits_used: 15
            },
        ...
        assert_eq!(
            t.decode(0b_111_1111_1111_1111_0_u16.reverse_bits()),
            DecodeResult {
                symbol: 15,
                bits_used: 15
            },
